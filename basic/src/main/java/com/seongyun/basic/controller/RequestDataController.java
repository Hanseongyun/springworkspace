...
public class RequestDataController {
    ...
    // HTTP GET localhost:4000/request-data/request-param?userld=qwer&userName=gildong
    
    public String getRequestParam(
        @RequestParam(name="userId") String userId,         /* ?뒤부터 읽어서 userId라는 name을 읽어서 데이터(qwer)을 Sting userId의 userId에 넣음 */
        @RequestParam(name="userName", required = false) String userName,    /* required = false 필수가 아님 */
    ...
    //! *****주의
    // URL 패턴으로 데이터를 받아오는 방식을 썼을때 겹치는 패턴이 존재하는지 잘 확인해야 함
