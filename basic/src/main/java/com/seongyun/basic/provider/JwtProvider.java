package com.seongyun.basic.provider;
...
// - 인증 및 인가에 사용
// - 암호화가 되어 있어 클라이언트와 서버간의 안전한 데이터 교환을 할 수 있음
// - 헤더, 페이로드, 서명으로 구성됨
...
public class JwtProvider {
    ...
    // - Spring에서 Enviroment 객체를 이용하여 값을 가져옴

    // 3. 외부 데이터 관리 도구를 사용 (가장 이상적인 방법)
    ...
    public String validation(String jwt) {                    // 서브젝트 값을 반환하도록
