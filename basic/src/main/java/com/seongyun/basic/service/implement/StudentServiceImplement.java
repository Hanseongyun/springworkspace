package com.seongyun.basic.service.implement;
...
import com.seongyun.basic.repository.StudentRepository;
import com.seongyun.basic.service.StudentService;
...
public class StudentServiceImplement implements StudentService{
    ...
    // - boolean matches(평문패스워드, 암호화된패스워드) : 평문 패스워드와 암호화된 패스워드가 같은지 비교결과를 반환
