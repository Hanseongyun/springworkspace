package com.seongyun.basic.filter;
...
import com.seongyun.basic.provider.JwtProvider;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    // 2. 인증 토큰을 발급 받은 후 매 요청마다 request header의 Authorization 필드의 값으로 bearer 토큰을 포함하여 요청
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            // 3. principle에 대한 정보를 controller로 전달하기 위해 context에 담기
            ...
            // 3-2. 인증 요청에 대한 세부정보를 등록 / 웹 인증 정보 해당 리퀘스트에 등록
    ...
    private String parseBearerToken(HttpServletRequest request) {
        ...
        String token = authorization.substring(7);  // Bearer 뒤의값 전부 7부터
        return token;
